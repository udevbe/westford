...
class X11XkbFactory @Inject internal constructor(private val libxkbcommon: Libxkbcommon,
    ...
    fun create(xcbConnection: Long): Xkb {
        ...
        if (device_id == -1) {
            throw RuntimeException("Got an error while trying to fetch keyboard device id from X11 backend. " + "Unfortunately the docs of the xkb library do not specify how to get more information " + "about the error, so you'll have to do it with this lousy exception.")
        }
