...
@Lib(value = "png16",
     version = 16) class Libpng {

    @Ptr external fun png_create_write_struct(@Ptr(Char::class) user_png_ver: Long,
                                              @Ptr(Void::class) error_ptr: Long,
                                              @Ptr(png_error_ptr::class) error_fn: Long,
                                              @Ptr(png_error_ptr::class) warn_fn: Long): Long

    @Ptr external fun png_create_info_struct(@Ptr png_ptr: Long): Long
