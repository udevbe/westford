...
@Singleton @Lib(value = "input",
                version = 10) class Libinput {

    @Ptr external fun libinput_udev_create_context(@Ptr(libinput_interface::class) interface_: Long,
                                                   @Ptr(Void::class) user_data: Long,
                                                   @Ptr udev: Long): Long

    @Ptr external fun libinput_unref(@Ptr libinput: Long): Long
    ...
    @Ptr external fun libinput_get_event(@Ptr libinput: Long): Long

    @Ptr external fun libinput_event_destroy(@Ptr libinput: Long): Long

    external fun libinput_get_fd(@Ptr libinput: Long): Int

    external fun libinput_event_get_type(@Ptr event: Long): Int

    @Ptr external fun libinput_event_get_keyboard_event(@Ptr event: Long): Long

    @Ptr external fun libinput_event_get_pointer_event(@Ptr event: Long): Long

    @Ptr external fun libinput_event_get_touch_event(@Ptr event: Long): Long

    @Unsigned external fun libinput_event_keyboard_get_time(@Ptr event: Long): Int

    external fun libinput_event_keyboard_get_key_state(@Ptr event: Long): Int

    @Unsigned external fun libinput_event_keyboard_get_seat_key_count(@Ptr event: Long): Int

    @Unsigned external fun libinput_event_keyboard_get_key(@Ptr event: Long): Int
    ...
    @Unsigned external fun libinput_event_pointer_get_button(@Ptr event: Long): Int

    external fun libinput_event_pointer_get_button_state(@Ptr event: Long): Int

    @Unsigned external fun libinput_event_pointer_get_seat_button_count(@Ptr event: Long): Int

    @Unsigned external fun libinput_event_pointer_get_time(@Ptr event: Long): Int
    ...
    @Unsigned external fun libinput_event_touch_get_time(@Ptr event: Long): Int
    ...
    @Ptr external fun libinput_event_get_device(@Ptr event: Long): Long
    ...
    @Ptr(Void::class) external fun libinput_device_get_user_data(@Ptr device: Long): Long

    @Ptr(String::class) external fun libinput_device_get_output_name(@Ptr device: Long): Long

    @Ptr external fun libinput_device_ref(@Ptr device: Long): Long

    @Ptr external fun libinput_device_unref(@Ptr device: Long): Long
