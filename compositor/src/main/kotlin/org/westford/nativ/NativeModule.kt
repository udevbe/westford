...
@Module class NativeModule {
    ...
    @Singleton @Provides internal fun provideLibpthread(): Libpthread {
        Libpthread_Symbols().link()
        return Libpthread()
    }

    @Singleton @Provides internal fun provideLibpng(): Libpng {
        Libpng_Symbols().link()
        return Libpng()
    }

    @Singleton @Provides internal fun provideLibinput(): Libinput {
        Libinput_Symbols().link()
        return Libinput()
    }

    @Singleton @Provides internal fun provideLibudev(): Libudev {
        Libudev_Symbols().link()
        return Libudev()
    }

    @Singleton @Provides internal fun provideLibdrm(): Libdrm {
        Libdrm_Symbols().link()
        return Libdrm()
    }

    @Singleton @Provides internal fun provideLibgbm(): Libgbm {
        Libgbm_Symbols().link()
        return Libgbm()
    }

    @Singleton @Provides internal fun provideLibbcm_host(): Libbcm_host {
    ...
    @Singleton @Provides internal fun provideLibpixman1(): Libpixman1 {
        Libpixman1_Symbols().link()
        return Libpixman1()
    }

    @Singleton @Provides internal fun provideLibc(): Libc {
        Libc_Symbols().link()
        return Libc()
    }

    @Singleton @Provides internal fun provideLibegl(): LibEGL {
        LibEGL_Symbols().link()
        return LibEGL()
    }

    @Singleton @Provides internal fun provideLibgles2(): LibGLESv2 {
        LibGLESv2_Symbols().link()
        return LibGLESv2()
    }

    @Singleton @Provides internal fun provideLibX11(): LibX11 {
        LibX11_Symbols().link()
        return LibX11()
    }

    @Singleton @Provides internal fun provideLibxcb(): Libxcb {
        Libxcb_Symbols().link()
        return Libxcb()
    }

    @Singleton @Provides internal fun provideLibX11xcb(): LibX11xcb {
        LibX11xcb_Symbols().link()
        return LibX11xcb()
    }

    @Singleton @Provides internal fun provideLibxkbcommon(): Libxkbcommon {
        Libxkbcommon_Symbols().link()
        return Libxkbcommon()
    }

    @Singleton @Provides internal fun provideLibxkbcommonx11(): Libxkbcommonx11 {
        Libxkbcommonx11_Symbols().link()
        return Libxkbcommonx11()
    }

    @Singleton @Provides internal fun provideNativeFileFactory(libc: Libc): NativeFileFactory {
