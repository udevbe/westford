 ...
 */
package org.westford.nativ.libxkbcommonx11
...
@Singleton @Lib(value = "xkbcommon-x11",
                version = 0) class Libxkbcommonx11 {
     ...
     */
    external fun xkb_x11_get_core_keyboard_device_id(@Ptr connection: Long): Int
     ...
     */
    @Ptr external fun xkb_x11_keymap_new_from_device(@Ptr context: Long,
                                                     @Ptr connection: Long,
                                                     @Nonnegative device_id: Int,
                                                     flags: Int): Long
     ...
     */
    @Ptr external fun xkb_x11_state_new_from_device(@Ptr keymap: Long,
                                                    @Ptr connection: Long,
                                                    @Nonnegative device_id: Int): Long
}
