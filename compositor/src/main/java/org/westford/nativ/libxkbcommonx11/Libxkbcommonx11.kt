...
@Singleton
@Lib(value = "xkbcommon-x11", version = 0)
class Libxkbcommonx11 {
     ...
     */
    @Ptr
    external fun xkb_x11_keymap_new_from_device(@Ptr context: Long,
                                                @Ptr connection: Long,
     ...
     */
    @Ptr
    external fun xkb_x11_state_new_from_device(@Ptr keymap: Long,
                                               @Ptr connection: Long,
