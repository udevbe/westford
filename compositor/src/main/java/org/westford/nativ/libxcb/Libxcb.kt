...
class Libxcb {
    ...
    @Ptr
    external fun xcb_get_setup(@Ptr c: Long): Long

    @ByVal(xcb_screen_iterator_t::class)
    external fun xcb_setup_roots_iterator(@Ptr setup: Long): Long
    ...
    @Ptr
    external fun xcb_poll_for_event(@Ptr c: Long): Long
    ...
    @Ptr
    external fun xcb_intern_atom_reply(@Ptr c: Long,
                                       cookie: Int,
                                       @Ptr e: Long): Long
