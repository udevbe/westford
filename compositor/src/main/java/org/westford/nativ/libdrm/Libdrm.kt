...
class Libdrm {
    ...
    external fun drmModeGetResources(fd: Int): Long

    /**
     * Retrieve information about the connector connectorId.
     */
    @Ptr(DrmModeConnector::class)
    external fun drmModeGetConnector(fd: Int,
    ...
    external fun drmModeGetEncoder(fd: Int,
