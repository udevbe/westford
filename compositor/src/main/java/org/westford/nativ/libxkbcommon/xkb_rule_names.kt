...
@Struct(Field(name = "rules", type = CType.POINTER, dataType = String::class), Field(name = "model", type = CType.POINTER, dataType = String::class), Field(name = "layout", type = CType.POINTER, dataType = String::class), Field(name = "variant", type = CType.POINTER, dataType = String::class), Field(name = "options", type = CType.POINTER, dataType = String::class))
class xkb_rule_names : xkb_rule_names_Jaccall_StructType()
/**
