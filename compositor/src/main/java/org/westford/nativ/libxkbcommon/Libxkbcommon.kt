...
class Libxkbcommon {
     ...
     */
    @Ptr
    external fun xkb_context_new(flags: Int): Long
     ...
     */
    @Ptr
    external fun xkb_keymap_new_from_names(@Ptr context: Long,
                                           @Ptr names: Long,
                                           flags: Int): Long
     ...
     */
    @Ptr
    external fun xkb_state_new(@Ptr keymap: Long): Long
     ...
     */
    @Ptr
    external fun xkb_keymap_get_as_string(@Ptr keymap: Long,
                                          format: Int): Long
