...
class Libgbm {
     ...
     */
    @Ptr
    external fun gbm_create_device(fd: Int): Long
     ...
     */
    @Ptr
    external fun gbm_surface_create(@Ptr gbm: Long,
                                    @Unsigned width: Int,
                                    @Unsigned height: Int,
                                    @Unsigned format: Int,
     ...
     */
    @Ptr
    external fun gbm_bo_get_user_data(@Ptr bo: Long): Long
     ...
     */
    @Ptr
    external fun gbm_bo_get_device(@Ptr bo: Long): Long
     ...
     */
    @Unsigned
    external fun gbm_bo_get_width(@Ptr bo: Long): Int
     ...
     */
    @Unsigned
    external fun gbm_bo_get_height(@Ptr bo: Long): Int
     ...
     */
    @Unsigned
    external fun gbm_bo_get_stride(@Ptr bo: Long): Int
     ...
     */
    @Unsigned
    external fun gbm_bo_get_format(@Ptr bo: Long): Int
     ...
     */
    @Ptr
    external fun gbm_surface_lock_front_buffer(@Ptr surface: Long): Long
     ...
     */
    @Ptr
    external fun gbm_bo_import(@Ptr gbm: Long,
                               @Unsigned type: Int,
                               @Ptr buffer: Long,
