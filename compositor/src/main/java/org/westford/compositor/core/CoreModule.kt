...
class CoreModule {
    ...
    @Provides
    internal fun provideFiniteRegion(finiteRegionFactory: FiniteRegionFactory): FiniteRegion {
        return finiteRegionFactory.create()
    }

    @Provides
    @Singleton
    internal fun provideInfiniteRegion(finiteRegionFactory: FiniteRegionFactory): InfiniteRegion {
        return InfiniteRegion(finiteRegionFactory)
    }

    @Provides
    internal fun providePointerDevice(pointerDeviceFactory: PointerDeviceFactory): PointerDevice {
        return pointerDeviceFactory.create()
    }

    @Provides
    @Singleton
    internal fun provideNullRegion(): NullRegion {
        return NullRegion()
    }

    @Provides
    @Singleton
    internal fun provideDisplay(): Display {
        return Display.create()
    }

    @Singleton
    @Provides
    internal fun provideJobExecutor(display: Display,
