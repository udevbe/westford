...
class SubsurfaceFactory @Inject
internal constructor(private val privateSubsurfaceFactory: PrivateSubsurfaceFactory) {
    ...
    fun create(parentWlSurfaceResource: WlSurfaceResource,
                ...
                .ifPresent { role ->
                    role.accept(object : RoleVisitor {
                        override fun visit(parentSubsurface: Subsurface) {
                            parentSubsurface.effectiveSyncSignal
                                    .connect(Slot<Boolean> { subsurface.updateEffectiveSync(it) })
                        }
                    })
                }
        ...
        parentSurface.pendingSubsurfaces
                .add(subsurface)
