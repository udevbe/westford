...
@AutoFactory(allowSubclasses = true, className = "PrivateSubsurfaceFactory")
class Subsurface internal constructor(val parentWlSurfaceResource: WlSurfaceResource,
                                      val sibling: Sibling,
    ...
    fun apply(surfaceState: SurfaceState) {
        ...
        val wlSurface = sibling.wlSurfaceResource
