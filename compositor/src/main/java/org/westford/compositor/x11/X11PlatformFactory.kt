...
class X11PlatformFactory @Inject
internal constructor(private val display: Display,
    ...
    private fun internX11Atoms(connection: Long): Map<String, Int> {
        val atomNames = arrayOf("WM_PROTOCOLS", "WM_NORMAL_HINTS", "WM_SIZE_HINTS", "WM_DELETE_WINDOW", "WM_CLASS", "_NET_WM_NAME", "_NET_WM_ICON", "_NET_WM_STATE", "_NET_WM_STATE_FULLSCREEN", "_NET_SUPPORTING_WM_CHECK", "_NET_SUPPORTED", "STRING", "UTF8_STRING", "CARDINAL", "_XKB_RULES_NAMES")
    ...
    private fun addX11RenderOutput(x11Outputs: MutableList<X11Output>,
        ...
        val values = Pointer.nref(XCB_EVENT_MASK_KEY_PRESS or
