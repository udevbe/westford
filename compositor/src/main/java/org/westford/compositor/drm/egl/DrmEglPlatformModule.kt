...
@Module(includes = arrayOf(TtyModule::class))
class DrmEglPlatformModule {

    @Provides
    @Singleton
    internal fun createDrmPlatform(drmPlatformFactory: DrmPlatformFactory): DrmPlatform {
        return drmPlatformFactory.create()
    }

    @Provides
    @Singleton
    internal fun createPlatform(drmEglPlatformFactory: DrmEglPlatformFactory): RenderPlatform {
