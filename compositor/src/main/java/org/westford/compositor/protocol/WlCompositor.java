...
public class WlCompositor extends Global<WlCompositorResource> implements WlCompositorRequestsV4, ProtocolObject<WlCompositorResource> {
    ...
    @Nonnull
    private final org.westford.compositor.core.FiniteRegionFactory finiteRegionFactory;
    @Nonnull
    private final org.westford.compositor.core.SurfaceFactory      surfaceFactory;
    @Nonnull
    ...
    WlCompositor(@Nonnull final Display display,
                 ...
                 @Nonnull final org.westford.compositor.core.FiniteRegionFactory finiteRegionFactory,
                 @Nonnull final org.westford.compositor.core.SurfaceFactory surfaceFactory,
