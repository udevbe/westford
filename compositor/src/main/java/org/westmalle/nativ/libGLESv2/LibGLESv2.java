 ...
 */
package org.westmalle.nativ.libGLESv2;
...
public class LibGLESv2 {
    ...
    public native void glPixelStorei(int pname,
                                     int param);

    public native void glDeleteShader(final int shader);

    public native void glActiveTexture(int texture);

    public native void glUniform1i(int location,
                                   int v0);
