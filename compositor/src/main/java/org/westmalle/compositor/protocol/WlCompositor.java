...
import org.westmalle.compositor.core.Compositor;
...
import org.westmalle.compositor.protocol.WlRegionFactory;
import org.westmalle.compositor.protocol.WlSurfaceFactory;
...
public class WlCompositor extends Global<WlCompositorResource> implements WlCompositorRequestsV4, ProtocolObject<WlCompositorResource> {
    ...
    @Nonnull
    private final org.westmalle.compositor.core.FiniteRegionFactory finiteRegionFactory;
    @Nonnull
    private final org.westmalle.compositor.core.SurfaceFactory      surfaceFactory;
    @Nonnull
    ...
    WlCompositor(@Nonnull final Display display,
                 ...
                 @Nonnull final org.westmalle.compositor.core.FiniteRegionFactory finiteRegionFactory,
                 @Nonnull final org.westmalle.compositor.core.SurfaceFactory surfaceFactory,
