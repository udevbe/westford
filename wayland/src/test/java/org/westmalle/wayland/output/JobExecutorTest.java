...
//                                         any())).thenReturn(eventSource);
//
//        when(Libc.write(eq(this.pipeWR),
//                             eq(new Memory(1)),
...
//
//        verify(Libc).write(eq(this.pipeWR),
//                                eq(new Memory(1)),
//                                eq(1));
//        verify(eventSource).remove();
//        verify(Libc).close(this.pipeR);
//        verify(Libc).close(this.pipeWR);
//    }
//
//    @Test
