...
public class Mat4Test {
    ...
    public void testMultiplyVec() throws Exception {
        ...
        final Vec4 right = Vec4.create(11f,66f,-1.5f,-4f);
    ...
    public void testInvert() throws Exception {
        ...
        //then
        assertThat(result.getM00()).isIn(Range.closed(-24.0001f, -23.9999f));//24
        assertThat(result.getM01()).isIn(Range.closed(19.9999f,20.0001f));//20
        assertThat(result.getM02()).isIn(Range.closed(-5.0001f,-4.9999f));//-5
        assertThat(result.getM03()).isIn(Range.closed(-.0001f,0.0001f));//0

        assertThat(result.getM10()).isIn(Range.closed(17.9999f,18.0001f));//18
        assertThat(result.getM11()).isIn(Range.closed(-15.0001f,-14.9999f));//-15
        assertThat(result.getM12()).isIn(Range.closed(3.9999f,4.0001f));//4
        assertThat(result.getM13()).isIn(Range.closed(-.0001f,0.0001f));//0

        assertThat(result.getM20()).isIn(Range.closed(4.9999f,5.0001f));//5
        assertThat(result.getM21()).isIn(Range.closed(-4.0001f,3.9999f));//-4
        assertThat(result.getM22()).isIn(Range.closed(.9999f,1.0001f));//1
        assertThat(result.getM23()).isIn(Range.closed(-.0001f,0.0001f));//0

        assertThat(result.getM30()).isIn(Range.closed(-.0001f,0.0001f));//0
        assertThat(result.getM31()).isIn(Range.closed(-.0001f,0.0001f));//0
        assertThat(result.getM32()).isIn(Range.closed(-.0001f,0.0001f));//0
        assertThat(result.getM33()).isIn(Range.closed(.9999f,1.0001f));//1
    }
